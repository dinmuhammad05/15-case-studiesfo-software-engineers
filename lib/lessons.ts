...
export const lessons: Lesson[] = [
  {
    ...
    summary:
      "Bitta GPU'dagi prototipdan haftasiga yuz millionlab foydalanuvchiga xizmat qiladigan inference platformagacha.",
    accent: "#10a37f",
    status: "tayyor",
    level: "o'rta",
    minutes: 32,
    topics: ["LLM inference", "KV cache", "Batching", "Streaming", "RAG"],
  },
  {
    order: 2,
    slug: "url-shortener",
    title: "URL qisqartiruvchi qanday ishlaydi",
    summary: "bit.ly darajasidagi tizim: kalit generatsiyasi, kesh, redirect va analitika.",
    accent: "#ee6123",
    status: "rejada",
    level: "boshlang'ich",
    minutes: 24,
    topics: ["Base62", "Kalit generatsiya", "Redis kesh", "301 vs 302"],
  },
  {
    order: 3,
    slug: "redis",
    title: "Redis'ning 12 ta asosiy stsenariysi",
    summary: "Kesh, sessiya, rate limiter, leaderboard, navbat, lock — qachon va nega ishlatiladi.",
    accent: "#dc382d",
    status: "rejada",
    level: "boshlang'ich",
    minutes: 26,
    topics: ["Kesh", "Rate limit", "Sorted set", "Pub/Sub", "Lua"],
  },
  {
    order: 4,
    slug: "twitter",
